<?php
    ...
    $stmtContratMaintenance = $pdo->prepare("SELECT m.*, c.application_source FROM details_maintenance m INNER JOIN contrat c ON m.id_contrat = c.id_contrat");
            ...
            <div class="content">
                <div class="content-panel">
                    <div class="vertical-tabs">
                        ...
                        <a href="C_DetailMaintenance.php" style="background-color: var(--c-background-tertiary); color: var(--c-accent-primary);">Contrat de maintenance</a>
