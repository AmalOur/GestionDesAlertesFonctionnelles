...
<body>
    ...
    <div class="responsive-wrapper">
            ...
            <div class="content">
                <div class="content-panel">
                    <div class="vertical-tabs">
                        <a href="C_DetailSSL.php" style="background-color: var(--c-background-tertiary); color: var(--c-accent-primary);">Certificat SSL</a>
        ...
        <script>
            ...
            function createCertificateItem(nomSociete, dateDebut, dateFin) {
                const certificateItem = document.createElement("div");
                certificateItem.classList.add("certificate");

                const certificateName = document.createElement("h3");
                certificateName.textContent = nomSociete;
